...
| `exportBackup(button?)` inner                        | Downloads JSON backup.                                                                       | optional button                                | `Promise<void>`                           | Creates Blob URL and temporary anchor named `frelancia_backup_<date>.json`; revokes URL.                        |
